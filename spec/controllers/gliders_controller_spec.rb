  ...
  context 'Authenticated' do
    context 'Has gliders' do
      ...
      context 'Strong params' do
        it { should permit(:immatriculation, :name, :self_launching, :double_seater).for(:create) }
        it { should permit(:immatriculation, :name, :self_launching, :double_seater).for(:update, params: { id: glider.id }) }
      end
    end
